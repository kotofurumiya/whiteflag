  ...
  render() {
    ...
    const mediaList = this.props.toot.media_attachments.map((media: MastodonAttachment) => {
      if(media.type === 'video' || media.type === 'gifv') {
        return <div key={media.id} className="toot-media-attachment">
          <video
      ...
      <div className="toot-container">
          <div className="toot">
            ...
            <div className="toot-main">
              ...
              <div className="toot-content" dangerouslySetInnerHTML={{__html: tootContent}} ref={this._tootContentRef}/>
              {spoiler}
              <div className="toot-media-attachments-container">
                {mediaList}
              </div>
